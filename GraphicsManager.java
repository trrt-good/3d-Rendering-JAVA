...
public class GraphicsManager 
{
    ...
    {
        gameObject1 = new GameObject(new Vector3(0, -200, 1000), "nature.obj", new Color(50, 50, 50), new EulerAngle(Math.toRadians(90), Math.toRadians(0), Math.toRadians(0)), 20, false);
