...
public class GraphicsManager 
{
    ...
    {
        gameObject1 = new GameObject(new Vector3(0, 0, 1000), "lowPolyPlane1.obj", new Color(50, 50, 50), new EulerAngle(Math.toRadians(0), Math.toRadians(0), Math.toRadians(0)), 1);
